...
有时候，您也可能具有最初看起来同样无形的目标，例如品牌价值或忠诚度。 能够测量这些指标以便将其用作Personalization活动的目标指标至关重要。 通常，这些类型的目标仍然可以与收入影响（如生命周期客户价值或客户获取成本）保持一致。在开展计划的同时，请务必根据关键业务目标定期审查计划绩效，以确保从Personalization计划中获取价值。
