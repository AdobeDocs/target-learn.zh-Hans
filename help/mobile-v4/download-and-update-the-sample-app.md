...
根据文档[&#128279;](https://experienceleague.adobe.com/docs/mobile-services/android/getting-started-android/requirements.html?lang=en)，Adobe Mobile Services SDK已在We.Travel应用程序中预安装。 现在将更新安装以指向您自己的[!DNL Target]帐户。
